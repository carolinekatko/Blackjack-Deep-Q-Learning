...
# Source code altered for test 4
    ...
    def run(self, is_training=True, render=False):
        ...
        for episode in itertools.count():
            ...
            while not terminated and episode_reward < self.stop_on_reward:
                ...
                #print(f"Episode {episode}, Step Reward: {reward:.2f}, State: {state.tolist()}, Action: {'Hit' if action == 1 else 'Stand'}, New State: {new_state.tolist()}")
